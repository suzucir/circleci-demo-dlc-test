...
###
FROM circleci/node:14.5.0-buster-browsers-legacy
...
RUN if grep -q Debian /etc/os-release && grep -q jessie /etc/os-release; then \
    ...
    && sudo apt-get update; sudo apt-get install -y -t jessie-backports openjdk-11-jre openjdk-11-jre-headless openjdk-11-jdk openjdk-11-jdk-headless \
